...
function searchbar_listener(event) {
    ...
    if (q !== '') {
      var url = 'https://github.com/itagn/blog/search?utf8=✓&q=' + encodeURIComponent(q);
...
function router() { 
  ...
  $.get(path, function(data) {
    ...
    (function() {
      ...
      window.disqus_url = 'https://itagn.github.io/blog/' + (location.hash ? location.hash.replace("#", "") : 'README');
